...
def main() -> None:
    ...
    try:
        ...
        dp.add_handler(CallbackQueryHandler(buy_premium, pattern="^(buy_flare|buy_instant|buy_shine|buy_mood|buy_vault|buy_premium_pass)$"))
        dp.add_handler(CallbackQueryHandler(set_mood, pattern="^(mood_chill|mood_deep|mood_fun|mood_clear)$"))
